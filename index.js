...
const sqlRouter = require("./api/sql_terminal/sql.router");
...
const { createPlayground } = require("./api/sql_terminal/sql.controller");
...
app.use("/v1/production/api/sql", sqlRouter);
